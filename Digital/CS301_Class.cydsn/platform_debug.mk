...
DESIGN= CS301_Class
CONFIG= debug
TOOLCHAIN_DIR ?= C:/Program Files (x86)/Cypress/PSoC Creator/4.1/PSoC Creator/import/gnu/arm/5.4.1/bin
...
CFLAGS_CortexM3= -mcpu=cortex-m3 -mthumb -I./system -I./control -I. -IGenerated_Source/PSoC5 -Wa,-alh=$(OUT_DIR_CortexM3)/$(basename $(<F)).lst -g -D DEBUG -Wall -ffunction-sections -ffat-lto-objects -O0
...
LDFLAGS_CortexM3= -mcpu=cortex-m3 -mthumb -L Generated_Source/PSoC5 -L system -L control -Wl,-Map,$(OUT_DIR_CortexM3)/$(DESIGN).map -T Generated_Source/PSoC5/cm3gcc.ld -specs=nano.specs -Wl,--gc-sections -g -ffunction-sections -O0 -ffat-lto-objects
